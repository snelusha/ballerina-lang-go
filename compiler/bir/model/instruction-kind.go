...
const (
	InstructionKindGoto                      InstructionKind = 1
	InstructionKindCall                      InstructionKind = 2
	InstructionKindBranch                    InstructionKind = 3
	InstructionKindReturn                    InstructionKind = 4
	InstructionKindAsyncCall                 InstructionKind = 5
	InstructionKindWait                      InstructionKind = 6
	InstructionKindFPCall                    InstructionKind = 7
	InstructionKindWKReceive                 InstructionKind = 8
	InstructionKindWKSend                    InstructionKind = 9
	InstructionKindFlush                     InstructionKind = 10
	InstructionKindLock                      InstructionKind = 11
	InstructionKindFieldLock                 InstructionKind = 12
	InstructionKindUnlock                    InstructionKind = 13
	InstructionKindWaitAll                   InstructionKind = 14
	InstructionKindWKAltReceive              InstructionKind = 15
	InstructionKindWKMultipleReceive         InstructionKind = 16
...
func (i InstructionKind) GetValue() byte {
	return byte(i)
}
